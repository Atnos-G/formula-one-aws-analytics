...
## Documentation & lineage (dbt)

The project includes autogenerated dbt documentation with model descriptions,
tests and lineage.

- Generated dbt docs: `docs/dbt_docs/index.html`

### Examples

**Model lineage (facts & dimensions)**  
![dbt lineage](docs/screenshots/dbt_lineage_fct_results.png)

**Model documentation (columns & tests)**  
![dbt model documentation](docs/screenshots/dbt_dim_races.png)
